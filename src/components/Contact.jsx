...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    emailjs.send('service_1ecw0o2', 'template_wykj592', { from_name: form.name, to_name: 'Santhosh', from_email: form.email, to_email: 'santhoshcv2004@gmail.com', message: form.message }, 'fLpvrXfnI0PoU9bY-' ).then(() => {
      setLoading(false);
